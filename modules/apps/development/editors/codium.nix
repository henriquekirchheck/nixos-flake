{ den, inputs, ... }:
{
  ...
  den.aspects.apps.provides.development.provides.editors.provides.codium = {
            ...
            userSettings =
              let
                settings = {
                  ...
                  "javascript.preferences.organizeImports" = settings."typescript.preferences.organizeImports";
                  ...
                  "godotTools.editorPath.godot4" = lib.getExe pkgs.godot;
